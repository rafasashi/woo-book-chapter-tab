...
<div class="landing">
    ...
    <section class="section-odd clear" style="background: url(<?php echo $this->parent->assets_url . 'images/'?>02-bg.png?<?php echo time(); ?>) no-repeat transparent; background-position: 15% 90%">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>Don't keep the tab name "Chapters" and rename the tab to anything you want like "Docs" or "Table of content".</p>
            </div>
            <div class="col-1">
    ...
    <section class="section-even clear" style="background: url(<?php echo $this->parent->assets_url . 'images/'?>03-bg.png?<?php echo time(); ?>) no-repeat #f7f7f7; background-position: 85% 90%">
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>Show the chapters and sections in a dynamic accordion. It works on all modern browsers.</p>
            </div>
        </div>
    </section>
    <section class="section-odd clear" style="background: url(<?php echo $this->parent->assets_url . 'images/'?>04-bg.png?<?php echo time(); ?>) no-repeat transparent; background-position: 15% 90%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo $this->parent->assets_url . 'images/' ?>04-icon.png?<?php echo time(); ?>" alt="chapter Form" />
                    <h2>CHOW DOTTED LINES</h2>
                </div>
                <p>Show a line of dots between the section and the page number like the table of content of a book.</p>
            </div>
            <div class="col-1">
				<a href="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-4.png">
					<img src="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-4.png?<?php echo time(); ?>" alt="chapter Form" />
				</a>
			</div>
        </div>
    </section>
        ...
        <div class="landing-container">
            <div class="col-1">
				<a href="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-5.png">
					<img src="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-5.png?<?php echo time(); ?>" alt="Enhanced Editor" />
				</a>
			</div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo $this->parent->assets_url . 'images/' ?>05-icon.png?<?php echo time(); ?>" alt="Enhanced Editor" />
                    <h2>Enhanced Editor</h2>
                </div>
                <p>Replace the textarea editor by a fully featured editor in the backend to generate hyperlinks and page number for each sections.</p>
            </div>
        </div>
    </section>
    ...
    <section class="section-odd clear" style="background: url(<?php echo $this->parent->assets_url . 'images/'?>06-bg.png?<?php echo time(); ?>) no-repeat transparent; background-position: 15% 90%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo $this->parent->assets_url . 'images/' ?>06-icon.png?<?php echo time(); ?>" alt="Sortable chapters" />
                    <h2>Sortable Elements</h2>
                </div>
                <p>Rearrange the chapter and section order from the backend using the drag and drop feature and the up and down buttons.</p>
            </div>
            <div class="col-1">
				<a href="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-6.png">
					<img src="<?php echo $this->parent->assets_url . 'images/' ?>screenshot-6.png?<?php echo time(); ?>" alt="Sortable chapters" />
				</a>
			</div>
        </div>
    </section>
